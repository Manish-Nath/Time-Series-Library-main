...
# Patch length ablation values
for PATCH_LEN in 8 12 24 48
do
  echo "Running patch_len=$PATCH_LEN for pred_len=96"
  python -u run.py \
    --model_id ETTh1_96_96_patch$PATCH_LEN \
    --pred_len 96 \
    --patch_len $PATCH_LEN \
    --e_layers 1 \
    --batch_size 16 \
  ...
  echo "Running patch_len=$PATCH_LEN for pred_len=192"
  python -u run.py \
    --model_id ETTh1_96_192_patch$PATCH_LEN \
    --pred_len 192 \
    --patch_len $PATCH_LEN \
    --e_layers 2 \
    --batch_size 16 \
  ...
  echo "Running patch_len=$PATCH_LEN for pred_len=336"
  python -u run.py \
    --model_id ETTh1_96_336_patch$PATCH_LEN \
    --pred_len 336 \
    --patch_len $PATCH_LEN \
    --e_layers 2 \
    --batch_size 4 \
  ...
  echo "Running patch_len=$PATCH_LEN for pred_len=720"
  python -u run.py \
    --model_id ETTh1_96_720_patch$PATCH_LEN \
    --pred_len 720 \
    --patch_len $PATCH_LEN \
    --e_layers 1 \
    --batch_size 8 \
